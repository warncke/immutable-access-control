...
// get global singledton instance
ImmutableAccessControl.getGlobal = getGlobal
...
function allowModel (args) {
    ...
    if (args.accessId) {
        ...
        scope = args.accessId === args.session.accessId ? 'own' : 'any'
    }
 ...
 * @function getGlobal
 *
 * return global ImmutableAccessControl instance
 *
 * @returns {ImmutableAccessControl}
 */
function getGlobal () {
    // create new global instance if not defined
    if (!defined(global.__immutable_access_control__)) {
        global.__immutable_access_control__ = new ImmutableAccessControl()
    }
